return {
    {
      ...
      keys = function()
        return {
          ...
          { "<leader>xj", function() require("dap").step_into() end, desc = "Step Into", },
          ...
          { "<leader>xk", function() require("dap").step_out() end, desc = "Step Out", },
          { "<leader>xl", function() require("dap").step_over() end, desc = "Step Over", },
